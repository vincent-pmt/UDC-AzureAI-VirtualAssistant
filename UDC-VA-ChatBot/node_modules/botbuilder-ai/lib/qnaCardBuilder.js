...
class QnACardBuilder {
     ...
     */
    static getSuggestionsCard(suggestionsList, cardTitle, cardNoMatchText, useTeamsAdaptiveCard = false) {
     ...
     */
    static getQnAAnswerCard(result, displayPreciseAnswerOnly, useTeamsAdaptiveCard = false) {
        var _a, _b;
        if (!result) {
     ...
     */
    static getTeamsAdaptiveCard(cardText, buttonList) {
        ...
        return botbuilder_core_1.CardFactory.adaptiveCard(adaptiveCardJson);
    }
    /**
     ...
     */
    static getHeroCard(cardText, buttonList) {
        return botbuilder_core_1.CardFactory.heroCard(cardText, cardText, undefined, buttonList);
    }
}
