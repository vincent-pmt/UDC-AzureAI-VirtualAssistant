...
export interface ObjectSchema<Fields extends ObjectFieldSchema<string, Schema>[] | readonly ObjectFieldSchema<string, Schema>[] = ObjectFieldSchema<string, Schema>[] | readonly ObjectFieldSchema<string, Schema>[]> extends TType, WithValidator {
    __t: 'obj';
    fields: Fields;
...
export interface ObjectOptionalFieldSchema<K extends string = string, V extends Schema = any> extends ObjectFieldSchema<K, V> {
    optional: true;
}
...
export type TypeOf<T extends Schema> = T extends OrSchema<any> ? TypeOfValue<T['types'][number]> : T extends RefSchema<infer U> ? TypeOf<U> : T extends AnySchema ? unknown : TypeOfValue<T>;
